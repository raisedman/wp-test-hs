...
class MyCars
{
    ...
    {
        wp_register_script ('jQueryUI', plugins_url() . '/myCars/assets/js/jqueryui/jquery-ui.js');
        wp_register_script ('myScript', plugins_url() . '/myCars/assets/js/script.js', array('jquery', 'jQueryUI'), null, true);
    }
    ...
    public function regist_post ()
    {
        register_post_type ('post_type_name', array(
            ...
            'labels' => array(
                ...
                'singular_name' => __('Car'), // название для одной записи этого типа
                'add_new' => __('Add Car'), // для добавления новой записи
